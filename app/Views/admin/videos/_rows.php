<?php foreach ($videos as $video): ?>
    <tr class="hover:bg-gray-50 transition-colors">
        ...
        <td class="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap text-right text-[10px] lg:text-sm font-medium">
            ...
            <button hx-get="<?= base_url('admin/videos/delete/' . $video['id']) ?>" hx-confirm="Are you sure you want to delete this video?" hx-target="closest tr" hx-swap="outerHTML" class="text-red-600 hover:text-red-900 bg-red-50 px-2 lg:px-3 py-1 lg:py-1.5 rounded-lg hover:bg-red-100 transition-colors">Delete</button>
        </td>
    </tr>
<?php endforeach; ?>
