        ...
        <div x-show="showCreateModal" x-cloak style="display: none;" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showCreateModal" 
                    ...
                    <form action="<?= base_url('admin/videos') ?>" method="post" x-target="main-content">
                        <?= csrf_field() ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-100">
                    ...
                    <tbody id="video-table-body" class="bg-white divide-y divide-gray-100" x-init="setInterval(() => { $ajax('<?= current_url() ?>', { target: 'video-table-body' }) }, 5000)">
